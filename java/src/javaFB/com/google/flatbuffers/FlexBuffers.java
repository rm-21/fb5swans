...
import static javaFB.com.google.flatbuffers.FlexBuffers.Unsigned.byteToUnsignedInt;
import static javaFB.com.google.flatbuffers.FlexBuffers.Unsigned.intToUnsignedLong;
import static javaFB.com.google.flatbuffers.FlexBuffers.Unsigned.shortToUnsignedInt;
...
public class FlexBuffers {
    ...
    private static long readUInt(ReadBuf buff, int end, int byteWidth) {
        switch (byteWidth) {
            case 1: return Unsigned.byteToUnsignedInt(buff.get(end));
            case 2: return Unsigned.shortToUnsignedInt(buff.getShort(end));
            case 4: return Unsigned.intToUnsignedLong(buff.getInt(end));
    ...
    public static Reference getRoot(ReadBuf buffer) {
        ...
        int packetType = Unsigned.byteToUnsignedInt(buffer.get(--end));
    ...
    public static class Vector extends Sized {
        ...
        public Reference get(int index) {
            ...
            int packedType = Unsigned.byteToUnsignedInt(bb.get((int) (end + (len * byteWidth) + index)));
